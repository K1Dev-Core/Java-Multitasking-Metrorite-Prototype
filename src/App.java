...
public class App {
    private static final List<Asteroid> asteroids = new ArrayList<>(); // list เก็บอุกบาต
    private static JPanel asteroidPanel; // panel
    ...
    public static void setAsteroidCount(int count) {
        asteroidCount = count; // กำหนดจำนวนอุกบาต
    }
